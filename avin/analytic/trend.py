...
class TrendAnalytic(Analytic):
    ...
    def periodSize(cls, trend: Trend) -> Size | None:
        sizes = cls.getSizes(
            asset=trend.asset,
            tf=trend.timeframe,
            term=trend.term,
    ...
    def speedSize(cls, trend: Trend) -> Size | None:
        sizes = cls.getSizes(
            asset=trend.asset,
            tf=trend.timeframe,
            term=trend.term,
    ...
    def volumeBearSize(cls, trend: Trend) -> Size | None:
        sizes = cls.getSizes(
            asset=trend.asset,
            tf=trend.timeframe,
            term=trend.term,
    ...
    def volumeBullSize(cls, trend: Trend) -> Size | None:
        sizes = cls.getSizes(
            asset=trend.asset,
            tf=trend.timeframe,
            term=trend.term,
    ...
    def volumeTotalSize(cls, trend: Trend) -> Size | None:
        sizes = cls.getSizes(
            asset=trend.asset,
            tf=trend.timeframe,
            term=trend.term,
