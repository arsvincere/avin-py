...
class Tinkoff(Broker):
    ...
    def __dataCycle(cls):
        ...
        # TODO: надо на брокера переложить работу по поиску ассетов.
        # ведь если на них подписываются брокер их получает...
        # вот пусть кэширует и в эвентах выдавать сразу ассет, а не фиги
        # и вообще тогда он сам сможет законетить эти события на ассеты
        # и не надо будет в трейдере дополнительно их перехватывать
        # Как идея. Подумать.
