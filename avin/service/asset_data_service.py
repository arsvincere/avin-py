...
class AssetDataService:
    ...
    def ensure_time_footprint(
        ...
        if not asset.has_ticks():
            AssetDataService.load_ticks(asset, source, begin, end)

        AssetDataService.build_time_footprint(asset, tf)
    ...
    def ensure_tick_footprint(
        ...
        AssetDataService.build_tick_footprint(asset, ticks_per_cluster)
    ...
    def ensure_volume_footprint(
        ...
        AssetDataService.build_volume_footprint(asset, volume_per_cluster)
    ...
    def ensure_value_footprint(
        ...
        AssetDataService.build_value_footprint(asset, value_per_cluster)
