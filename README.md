<picture align="center">
  <img alt="Pandas Logo" src="https://github.com/arsvincere/avin-prototype/blob/master/res/cover/cover_0.png" alt="AVIN - Trade System">
</picture>

<div align="center">

![Python](https://img.shields.io/badge/Python-3.14-blue)
![Size](https://img.shields.io/github/repo-size/arsvincere/avin-prototype?label=Size)
![Activity](https://img.shields.io/github/commit-activity/m/arsvincere/avin-prototype?label=Commits)
![LOC](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Farsvincere%2Favin-prototype%2Fmaster%2F.github%2Fbadges%2Floc.json)
![Tests](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Farsvincere%2Favin-prototype%2Fmaster%2F.github%2Fbadges%2Ftests.json)
...
Содержит все, что нужно трейдеру: от загрузки исторических данных и
...
- **connect:** коннекторы, пока доступно подключение только к Тинькофф
  брокеру (Т-банк)
- **domain:** структуры для удобной работы с данными на "трейдерском языке":
...
- **gui:** для просмотра результатов тестов и др
...
<div align="center">
  <img src="https://github.com/arsvincere/avin-prototype/blob/master/res/screenshots/2025-02-08T09%3A38%3A34%2C639514036%2B03%3A00.png" alt="GUI screenshot">
</div>
