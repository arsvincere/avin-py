...
"""Doc
Тупо на открытии продает или покупает, на закрытии закрывает позицию
Используется в тест юнитах, для отладки тестера/трейдера.
Может быть использована как шаблон для своей стратегии.
"""
